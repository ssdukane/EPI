...
using EPi.Commerce.Core.Customers;
...
using EPi.Commerce.Web.ModelBuilders;
using EPi.Commerce.Web.ResetPassword;
using EPi.Commerce.Web.Services;
using EPi.Commerce.Web.Services.Email;
using EPi.Commerce.Web.Services.Email.Models;
using Postal;
using EmailService = EPi.Commerce.Web.Services.Email.EmailService;
using IEmailService = EPi.Commerce.Core.Email.IEmailService;
