...
using EPi.Commerce.Core.Extensions;
using EPi.Commerce.Core.Objects.SharedViewModels;
using EPi.Commerce.Core.PaymentProviders;
using EPi.Commerce.Core.PaymentProviders.DIBS;
using EPi.Commerce.Core.PaymentProviders.Payment;
...
using EPi.Commerce.Web.Models.ViewModels.Payment;
using LineItem = EPi.Commerce.Core.Objects.LineItem;
