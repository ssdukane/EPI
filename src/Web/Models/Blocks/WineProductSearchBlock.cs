...
using EPi.Commerce.Core.Attributes;
using EPi.Commerce.Web.EditorDescriptors;
using EPi.Commerce.Web.EditorDescriptors.Attributes;
using EPi.Commerce.Web.Models.Blocks.Base;
using EPi.Commerce.Web.Models.Catalog;
using EPi.Commerce.Web.Models.CustomProperties;
using EPi.Commerce.Web.Models.FindModels;

namespace EPi.Commerce.Web.Models.Blocks
{
    [ContentType(
